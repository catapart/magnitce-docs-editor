...
}`;var c=`<div id="viewer">\r
    <nav id="nav"></nav>\r
    <path-router id="router" path="/">\r
        <route-page id="welcome" path="/">\r
            <div class="container">\r
                <h2 class="header">Doc Editor</h2>\r
                <div class="panel">\r
                    <div class="description">\r
                        <p>Welcome to the Doc Editor!</p>\r
                    ...
                    <button class="button" type="button">New Document</button>\r
                </div>\r
            </div>\r
        </route-page>\r
        <route-page id="welcome" path="help">\r
            <div class="container">\r
...
\r
    <template id="nav-item">\r
        <a class="nav-item"></a>\r
    </template>\r
</div>\r
<div id="edit-content" contenteditable="true"></div>`;var s=":not(slot,defs,g,rect,path,circle,ellipse,line,polygon,text,tspan,use,svg image,svg title,desc,template,template *)";function u(a){let t=[...a.querySelectorAll(`${s}[id]`)];for(let e=0;e<t.length;e++)t[e].part.add(t[e].id);let r=[...a.querySelectorAll(`${s}[class]`)];for(let e=0;e<r.length;e++)r[e].part.add(...r[e].classList)}var n=new CSSStyleSheet;n.replaceSync(o);var i="doc-editor",l=class extends HTMLElement{findElement(t){return this.shadowRoot.getElementById(t)}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=c,this.shadowRoot.adoptedStyleSheets.push(n),this.#e=this.#t.bind(this)}connectedCallback(){this.addEventListener("click",this.#e),u(this.shadowRoot)}disconnectedCallback(){this.removeEventListener("click",this.#e)}#e;#t(t){let r=t.composedPath();console.log(r)}attributeChangedCallback(t,r,e){t==""}};customElements.get(i)==null&&customElements.define(i,l);export{l as DocEditorElement};
